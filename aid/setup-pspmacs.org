...
As is mentioned in the project's =README=, I have paid a price for using someone's configuration, hence, I suggest that the reader shouldn't.
This is NOT Spacemacs, nor DOOM-Emacs, not Crafted Emacs.
It reader should use this as
- A repository of =elisp= code snippets for their configuration, which they understand completely.
...
** Modularity
Coming from python, I would ordinarily have written this as separate modules,
imported them suitably and executed the necessary parts.
That would either require the user to select the correct script,
or supply correct flags and require me to bundle the scripts together.
